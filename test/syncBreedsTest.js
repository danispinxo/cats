...
describe('#breedDetails', () => {
  ...
  it(`returns an empty string if the selected breed isn't in the database`, () => {
    const expectedDesc = "";

    const basketballJones = breedDetails('basketballJones');
    assert.equal(expectedDesc, basketballJones);
  });
